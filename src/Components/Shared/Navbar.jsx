    ...
    <nav className="bg-dark border-gray-200 px-4 w-screen sm:px-4 py-4">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-dark">
            <li>
              <Link
                to="/home"
            ...
            <li>
              <button
                onClick={logout}
                type="button"
                className="flex items-center justify-center gap-2 py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0"
              >
                Logout
